...
try {
    ...
    Write-Host "Failed to load starship."
}
...
if ($host.Name -eq 'ConsoleHost') {
    ...
    Set-PSReadLineOption -AddToHistoryHandler {
        ...
        $ignoreContains = "cd ", "git commit", "npm ", "rimraf", "ng ", "ls ", "code ", "explorer ", "yarn "
...
try {
    ...
    Write-Host "Failed to initialize fnm."
}